...
@section('title', 'Modifier - ' . $ufr->name)
    ...
    <div class="mx-auto space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div class="flex justify-between items-center">
                <div>
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Modifier l'UFR</h2>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
            <form action="{{ route('university.ufrs.update', $ufr) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" id="name" name="name" value="{{ old('name', $ufr->name) }}" 
                            ...
                            <div>
                                ...
                                <input type="text" id="short_name" name="short_name" value="{{ old('short_name', $ufr->short_name) }}" 
                                       class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-purple-500 focus:ring-purple-500 dark:bg-gray-700 dark:text-white" 
                            ...
                            <div>
                                ...
                                <input type="text" id="code" name="code" value="{{ old('code', $ufr->code) }}" 
                                       class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-purple-500 focus:ring-purple-500 dark:bg-gray-700 dark:text-white" 
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="description" name="description" rows="3" 
                                          class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-purple-500 focus:ring-purple-500 dark:bg-gray-700 dark:text-white" 
                                          placeholder="Description des missions et domaines d'expertise de l'UFR...">{{ old('description', $ufr->description) }}</textarea>
                                @error('description')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="dean_name" name="dean_name" value="{{ old('dean_name', $ufr->dean_name) }}" 
                                       class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-purple-500 focus:ring-purple-500 dark:bg-gray-700 dark:text-white" 
                            ...
                            <div>
                                ...
                                <input type="email" id="contact_email" name="contact_email" value="{{ old('contact_email', $ufr->contact_email) }}" 
                                       class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-purple-500 focus:ring-purple-500 dark:bg-gray-700 dark:text-white" 
                            ...
                            <div>
                                ...
                                <input type="text" id="contact_phone" name="contact_phone" value="{{ old('contact_phone', $ufr->contact_phone) }}" 
                                       class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-purple-500 focus:ring-purple-500 dark:bg-gray-700 dark:text-white" 
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="building" name="building" value="{{ old('building', $ufr->building) }}" 
                                       class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-purple-500 focus:ring-purple-500 dark:bg-gray-700 dark:text-white" 
                            ...
                            <div>
                                ...
                                <select id="is_active" name="is_active" 
                                        class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-purple-500 focus:ring-purple-500 dark:bg-gray-700 dark:text-white">
                                    <option value="1" {{ old('is_active', $ufr->is_active) == '1' ? 'selected' : '' }}>Active</option>
                                    <option value="0" {{ old('is_active', $ufr->is_active) == '0' ? 'selected' : '' }}>Inactive</option>
                                </select>
                                @error('is_active')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="address" name="address" rows="2" 
                                          class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-purple-500 focus:ring-purple-500 dark:bg-gray-700 dark:text-white" 
                                          placeholder="Adresse physique de l'UFR...">{{ old('address', $ufr->address) }}</textarea>
                                @error('address')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div>
                        <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Départements liés</h3>
                        <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
                            <div class="flex items-start">
                                ...
                                <div>
                                    <h4 class="font-medium text-blue-800 dark:text-blue-200">Attention</h4>
                                    <p class="text-sm text-blue-700 dark:text-blue-300 mt-1">
                                        Cette UFR contient {{ $ufr->departments->count() }} département(s). 
                                        Modifications de structure peuvent affecter les départements liés.
                                    </p>
                                    <div class="mt-2">
                        ...
                        <div>
                            @if($ufr->departments->count() == 0)
                                <form action="{{ route('university.ufrs.destroy', $ufr) }}" method="POST" class="inline-block">
                                    ...
                                    @method('DELETE')
                                    <button type="submit" 
                                            onclick="return confirm('Êtes-vous absolument sûr de vouloir supprimer cette UFR ?\n\nCette action est irréversible.')"
                            ...
                            @else
                                <span class="text-sm text-gray-500 dark:text-gray-400">
                                    Suppression impossible : UFR contient des départements
                                </span>
                            @endif
                        </div>
...
<script>
// Auto-generation du code basé sur le nom (seulement si le code est vide ou auto-généré)
document.getElementById('name').addEventListener('input', function(e) {
    const name = e.target.value;
    const codeInput = document.getElementById('code');
    
    // Vérifier si c'est un code auto-généré (contient l'année) ou vide
    const currentCode = codeInput.value;
    const isAutoGenerated = currentCode === '' || /\d{2}$/.test(currentCode);
    
    if (isAutoGenerated && codeInput.dataset.manualEdit !== 'true') {
