    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="py-6">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Modifier l'Établissement</h1>
    ...
    <form action="{{ route('admin.schools.update', $school) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="type" 
                            ...
                            <option value="pre_university" {{ old('type', $school->type) === 'pre_university' ? 'selected' : '' }}>Pré-universitaire</option>
                            <option value="university" {{ old('type', $school->type) === 'university' ? 'selected' : '' }}>Universitaire</option>
                        </select>
                    ...
                    <div id="educational-levels-section" class="{{ old('type', $school->type) === 'university' ? 'hidden' : '' }}">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                            Niveaux éducatifs gérés <span class="text-red-500">*</span>
                        </label>
                        <div class="space-y-2">
                            @php
                                $currentLevels = old('educational_levels', $school->educational_levels ?? []);
                            @endphp
                            <label class="flex items-center">
                                <input type="checkbox" 
                                       ...
                                       {{ in_array('primary', $currentLevels) ? 'checked' : '' }}>
                            ...
                            <label class="flex items-center">
                                <input type="checkbox" 
                                       ...
                                       value="secondary"
                                       class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                       {{ in_array('secondary', $currentLevels) ? 'checked' : '' }}>
                                <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">
                            ...
                            <label class="flex items-center">
                                <input type="checkbox" 
                                       ...
                                       value="technical"
                                       class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                       {{ in_array('technical', $currentLevels) ? 'checked' : '' }}>
                                <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="address" 
                                  id="address"
                                  rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 @error('address') border-red-500 @enderror">{{ old('address', $school->address) }}</textarea>
                        @error('address')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="academic_system" 
                                ...
                                required>
                            <option value="trimestre" {{ old('academic_system', $school->academic_system) === 'trimestre' ? 'selected' : '' }}>Trimestre</option>
                            <option value="semestre" {{ old('academic_system', $school->academic_system) === 'semestre' ? 'selected' : '' }}>Semestre</option>
                        </select>
                    ...
                    <div>
                        ...
                        <select name="grading_system" 
                                ...
                                required>
                            <option value="20" {{ old('grading_system', $school->grading_system) === '20' ? 'selected' : '' }}>Sur 20</option>
                            <option value="100" {{ old('grading_system', $school->grading_system) === '100' ? 'selected' : '' }}>Sur 100</option>
                            <option value="custom" {{ old('grading_system', $school->grading_system) === 'custom' ? 'selected' : '' }}>Personnalisé</option>
                        </select>
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
            <div class="p-6">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">Laissez vide pour conserver les documents actuels.</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        @if($school->logo_path)
                        <div class="mb-3">
                            <img src="{{ \Storage::url($school->logo_path) }}" alt="Logo actuel" class="w-16 h-16 object-contain border border-gray-200 rounded">
                    ...
                    <div>
                        ...
                        <div class="mb-3">
                            <img src="{{ \Storage::url($school->stamp_path) }}" alt="Tampon actuel" class="w-16 h-16 object-contain border border-gray-200 rounded">
                            <p class="text-xs text-gray-500 mt-1">Tampon actuel</p>
                        </div>
                        @endif
                        <input type="file" 
                               name="stamp" 
                    ...
                    <div>
                        ...
                        <div class="mb-3">
                            <img src="{{ \Storage::url($school->signature_path) }}" alt="Signature actuelle" class="w-16 h-16 object-contain border border-gray-200 rounded">
